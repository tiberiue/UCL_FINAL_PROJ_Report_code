...
path = "/sps/atlas/k/khandoga/TrainGNN/Models/PNANet_e020_0.16732.pt"

#model_name = "LundTest_big"
model_name = "WTag_classifier"    
...
for file in files:
    ...
    with uproot.open(file) as infile:
        ...
        inputs = tree.arrays(INPUT_VARIABLES, library="pd")
...
#    test_loader = DataLoader(dataset, batch_size=batch_size, shuffle=False)
    ...
    print ("dataset dataset size:", len(dsids))
    ...
    print(y_pred)
    tagger_scores = np.array(y_pred).flatten()
