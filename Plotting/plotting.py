...
tagger_files["LundNet_class"] = "/eos/user/t/tmlinare/Lund_tagger/ljptagger/Models/weightscore/user.teris.10.1.tree.root_test.root_score_LundNetWeightedScores.root"
