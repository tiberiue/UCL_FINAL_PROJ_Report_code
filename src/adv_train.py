...
if __name__ == "__main__":
    ...
    for epoch in range(n_epochs_adv): # this may need to be bigger
     #   my_test(test_loader)
        ...
        ad_lt, clsf_lt, total_lt =  train_adversary(adv_loader, clsf, adv, optimizer, device, loss_parameter=0.1) ## loss = loss1 - loss_parameter*loss2
        ...
        ad_lv, clsf_lv, total_lv =  test_combined(val_loader, clsf, adv, device, loss_parameter=0.1) ## loss = loss1 - loss_parameter*loss2
