...
files = glob.glob("/sps/atlas/k/khandoga/MySamples/user.mykhando.26845597._000001.tree.root_train.root")
files += glob.glob("/sps/atlas/k/khandoga/MySamples/user.mykhando.26845601._000002.tree.root_train.root")
...
train_ds, validation_ds = TensorDataset (train_ds),TensorDataset(validation_ds)
